# Eres un comercial trabajando para una compañia que vende diversos productos. Quieres crear un programa para 
# realizar un seguimiento de los productos que has vendido y el valor total de las ventas Supongamos que hay un total de 10 productos.
...
for i in range(0, len(precio_productos)):
    ...
    dinero_total += dinero_por_producto

print("El numero total vendidas:", total_ventas)
print("La facturacion por producto:", facturacion_producto)
print("El dinero total es:", dinero_total)